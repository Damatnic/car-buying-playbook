    ...
    <div className="grid gap-2 sm:grid-cols-2 lg:grid-cols-3">
      {items.map(item => (
        <a
          ...
          className="group relative block rounded-lg border border-border bg-surface px-4 py-3 transition-all hover:-translate-y-0.5 hover:border-accent hover:shadow-lg hover:shadow-accent/10"
        >
